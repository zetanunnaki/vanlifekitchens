...
This is the pillar guide. If you are building a van kitchen and you need to understand 12V refrigeration top-to-bottom — what it is, how it compares to the alternatives, how to size it, how to power it, how to install it, which models to actually buy — this page is the starting point. Every more specific fridge article on VanLifeKitchen links back here, and this guide links out to every one of them.
